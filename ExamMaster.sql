-- INSTEAD OF COMPOSITE PRIMARY KEY ON CARETEAMTBL I HAVE A PRIMARY KEY ON THE CARETEAMID AND ALSO A UNIQUE CONSTRAINT 
-- UQ ON PATIENTID AND CARETEAMID BECAUSE OF THESE CONDITIONS 
/*Question 
Does the care team already exist when the patient is being admitted? 
Answer Yes. 
Question 
Can the care team already have been assigned to a patient? 
Answer No. */
-- WHEN COMPOSITE PRIMARY KEY, PATIENTID CANNOT BE NULL, SO I COULDN'T FIND AWAY TO HAVE THE CARE TEAM ALREADY EXIST BUT ALSO
--HAVE NO PATIENT ALREADY ASSIGNED TO IT
...
DROP TABLE #ListOfWardNurses
DROP TABLE #ListOfVaccinatedNurses
DROP TABLE #ListOfUnvaccinatedNurses
--IS THERE A PATIENT ASSIGNED TO THIS CARETEAM
