...
ELSE IF(@ECovidStatus LIKE 'positive' OR @ECovidStatus LIKE 'unknown')
BEGIN
...
ELSE IF(@INumberOfDoctorsInCareTeam = 0 AND @INumberOfNursesInCareTeam < 2)
BEGIN
